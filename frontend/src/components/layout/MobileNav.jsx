...
export default function MobileNav() {
  const { isWorker, canApprove } = useAuth();
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 safe-bottom">
      <div className="grid grid-cols-5 h-16">
        ...
        {/* Centre big button — New Sale */}
        <button
          onClick={() => navigate('/sales/new')}
          className="flex flex-col items-center justify-center">
          <div className="w-13 h-13 bg-blue-600 rounded-full flex items-center justify-center shadow-lg -mt-5 w-14 h-14">
